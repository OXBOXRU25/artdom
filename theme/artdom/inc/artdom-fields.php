	...
	acf_add_local_field_group(
		array(
			...
			'fields'   => array(
				...
				artdom_f( 'cookie_btn_no', 'Плашка про cookie: кнопка отказа', 'text', array( 'wrapper' => array( 'width' => 50 ), 'instructions' => 'Вторая кнопка при подключённом счётчике. Нажатие закрывает плашку и счётчик не включает.' ) ),
				artdom_f(
					'opt_metrika',

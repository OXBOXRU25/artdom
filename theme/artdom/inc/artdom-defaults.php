...
function artdom_defaults() {
	...
	$d = array(
		...
		/* 21.09.2026: плашка переделана по образцу afternow.co — три кнопки и
		   раскрывающийся список категорий. Тексты новых кнопок и категорий
		   тоже редактируются, иначе заказчик увидит на сайте слова, которых
		   нет ни в одном поле. */
		'cookie_btn_manage' => 'Настроить',
		'cookie_btn_save'   => 'Сохранить выбор',
		'cookie_cat_need'   => 'Необходимые — без них сайт не работает. Отключить нельзя.',
		'cookie_cat_stat'   => 'Аналитика — счётчик посещаемости.',
		'cookie_cat_none'   => 'Кроме необходимых, сайт ничего не собирает: счётчиков и трекеров на нём нет.',

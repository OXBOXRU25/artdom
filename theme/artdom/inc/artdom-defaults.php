...
function artdom_defaults() {
	...
	$d = array(
		...
		'cookie_text'     => 'Только технические cookie — без них сайт не работает. Счётчиков и трекеров нет.',
		'cookie_text_analytics' => 'Считаем посещаемость Яндекс.Метрикой. Без согласия счётчик не запускается.',

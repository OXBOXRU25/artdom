...
$artdom_posts = new WP_Query(
	array(
		'post_type'           => 'post',
		/* Шесть, а не три. Пока подборка была сеткой из трёх, три и хватало.
		   С 15.09.2026 это лента на всех ширинах — а лента из трёх карточек,
		   которые и так влезают в кадр, не листается вовсе: бегунок гаснет
		   общим правилом .slider--static, и слайдер остаётся слайдером только
		   на словах. Шесть дают ровно два кадра по три, как у объектов. */
		'posts_per_page'      => 6,
